...
left join transactions t on ep.user = t.user_id;
...
-- MAGIC %python
-- MAGIC # TODO
-- MAGIC tDF = spark.table("transactions")
-- MAGIC epDF = spark.read.table("events_pivot")
-- MAGIC
-- MAGIC (epDF
-- MAGIC  .join(tDF, tDF.user_id == epDF.user)
