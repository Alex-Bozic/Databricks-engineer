...
# TODO
abandoned_items_df = (abandoned_carts_df.select(explode(col("cart")).alias("items")).groupBy(col("items")).agg(count("*").alias("count"))
                     )
