...
# MAGIC %sh
# MAGIC ls -l /dbfs/mnt/dbacademy-users/alex.bozic@in516ht.com/data-engineer-learning-path/users-csv

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * from csv.`${DA.paths.users_csv}`
# MAGIC --SELECT * FROM csv.`{$DA.paths.users_csv}`
...
# MAGIC val testA = 10
# MAGIC
# MAGIC spark.conf.set("com.whatever.your_scope.eventsSchema", eventsSchema)
# MAGIC
# MAGIC println(testA)
# MAGIC
...
eventsSchema = spark.conf.get("com.whatever.your_scope.eventsSchema")
